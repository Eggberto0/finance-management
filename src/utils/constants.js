...
export const CATEGORY_ICONS = [
  'ShoppingCart', 'Utensils', 'Car', 'Heart', 'BookOpen', 'Shirt',
  'Zap', 'Smartphone', 'Gamepad2', 'Plane', 'PawPrint', 'DollarSign',
  'GraduationCap', 'Dumbbell', 'Music', 'ShoppingBag', 'Briefcase', 'Gift',
  'Home', 'Bus', 'Coffee', 'Pizza', 'Wifi', 'Tv',
]
